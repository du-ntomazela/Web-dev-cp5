    ...
    return(
        ...
        <div className="flex flex-col md:flex-row justify-center p-5">
            <div className="flex-col w-full md:w-1/2 mb-6 md:mb-0">
                ...
                Capaz de desenvolver soluções em SAP/BTP, Python, JavaScript, C++, HTML5 e CSS3, com conhecimento nas bibliotecas: Pandas, XML DOM, BotCity, React, Bootstrap, Tailwind, entre outras...</p>
            ...
            <div className="w-full md:w-1/2 flex justify-center">
                <img className="w-3/4 md:w-full object-cover" src="desenvolvedor.png" alt="Desenvolvedor" />
            </div>
        </div>
